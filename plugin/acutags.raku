...
=head1 NAME
    ...
    acutags.raku - Manage acutags within a file.

=head1 SYNOPSIS

        Just list the tags and the number of times they are used.
    acutags.rakupl -l $file
...
A typical file:
    ...
    ´baz    A long, multiline
    ´"          description.
    ´typ    A typical acutag.
    ´

    Lorem ipsum ´baz dolor sit ´typ amet.
