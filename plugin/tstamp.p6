...
=head1 NAME
    ...
    tstamp.p6 - Print timestamp formatted the way I like them.
...
sub format-it (DateTime $dt, $format-id) {
    ...
    ;
        ...
        # ⦃2014-06-28⦄
    $format-id == 1 && return sprintf '%s-%02d-%02d',
        $dt.year,
        $dt.month,
        $dt.day,
    ;
        ...
        # ⦃2016-01-17.17-18-34⦄
    $format-id == 2 && return sprintf "%s-%02d-%02d.%02d-%02d-%02d",
